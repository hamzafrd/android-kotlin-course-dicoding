package com.c23ps105.prodify.tflite
...
class Classifier(assetManager: AssetManager, modelPath: String, labelPath: String, inputSize: Int) {
    ...
    private fun getLabel(labelProbArray: Array<FloatArray>): String {
        val maxConfidenceIndex = labelProbArray[0].indices.maxByOrNull { labelProbArray[0][it] } ?: -1
        return labelList[maxConfidenceIndex]
    }
}