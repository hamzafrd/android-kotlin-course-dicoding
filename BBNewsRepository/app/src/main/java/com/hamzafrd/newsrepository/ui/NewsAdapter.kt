...
import com.hamzafrd.newsrepository.databinding.ItemNewsBinding
import com.hamzafrd.newsrepository.ui.NewsAdapter.MyViewHolder
import com.hamzafrd.newsrepository.utils.DateFormatter
...
class NewsAdapter(private val onBookmarkClick: (NewsEntity) -> Unit) :
    ...
    inner class MyViewHolder(val binding: ItemNewsBinding) : RecyclerView.ViewHolder(
        binding.root
    ) {
