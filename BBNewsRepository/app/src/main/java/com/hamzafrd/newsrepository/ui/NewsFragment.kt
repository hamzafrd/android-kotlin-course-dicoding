...
import com.hamzafrd.newsrepository.data.Result
import com.hamzafrd.newsrepository.data.SettingPreferences
import com.hamzafrd.newsrepository.databinding.FragmentNewsBinding
...
class NewsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /// Jangan lupa tambahkan juga di tab (code sehabis ini)
        val newsAdapter = NewsAdapter { news ->
            if (news.isBookmarked) {
                viewModel.unBookmarkNews(news)
            } else {
